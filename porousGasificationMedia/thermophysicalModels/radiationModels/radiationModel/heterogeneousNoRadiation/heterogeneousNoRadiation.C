...
Foam::radiation::heterogeneousNoRadiation::heterogeneousNoRadiation(const volScalarField& T,const volScalarField& porosityF,const volScalarField& surfF, const volScalarField& Ts)
:
