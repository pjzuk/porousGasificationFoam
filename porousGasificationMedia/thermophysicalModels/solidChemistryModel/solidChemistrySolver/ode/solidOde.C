...
Foam::solidOde<CompType, SolidThermo, GasThermo>::solidOde
(
    ODESolidHeterogeneousChemistryModel<CompType, SolidThermo, GasThermo>& model,
    const word& modelName
)
:
    solidChemistrySolver<CompType, SolidThermo, GasThermo>(model, modelName),
...
template<class CompType, class SolidThermo, class GasThermo>
Foam::scalar Foam::solidOde<CompType, SolidThermo,GasThermo>::solve
(
    scalarField& c,
    const scalar T,
    const scalar p,
